    ...
    fetch('/all-blogs')
      ...
      .then(blogs => {
        ...
        blogs.forEach(blog => {
          ...
          card.className = 'min-w-[320px] max-w-[320px] bg-white rounded-lg shadow-md overflow-hidden cursor-pointer transition-transform transform hover:scale-105 flex-shrink-0';
          card.innerHTML = `
